...
# -*- coding: utf-8 -*-
"""
Merge TXT and XLSX corpora into complete unified corpus
"""

import json

print("=== Merging Complete Corpus (TXT + XLSX) ===\n")

# Load TXT corpus (unified_corpus.json)
print("Loading TXT corpus...")
with open('unified_corpus.json', 'r', encoding='utf-8') as f:
    txt_corpus = json.load(f)

# Load XLSX corpus (rhyme_corpus.json)
...
# Save unified
with open('complete_corpus.json', 'w', encoding='utf-8') as f:
...
print(f"\n✓ Saved complete_corpus.json")
print(f"\n{'='*60}")
print(f"COMPLETE UNIFIED CORPUS")
print(f"{'='*60}")
